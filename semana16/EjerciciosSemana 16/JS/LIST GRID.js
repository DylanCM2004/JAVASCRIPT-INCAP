//CONFIGURACION DE FUNCIONES DE MODOS DE VISTAS LIST AND GRID
...
function listView() {
    ...
    elements[i].style.width = "100%"; //UNA IMAGUEN A LA VEZ
...
function gridView() {
    for (i = 0; i < elements.length; i++) {
    elements[i].style.width = "33.33%"; //TRES IMAGENES A LA VEZ 
